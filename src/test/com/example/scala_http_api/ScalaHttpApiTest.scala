...
import com.example.scala_http_api.user.infrastructure.marshaller.UserMarshaller
import com.example.scala_http_api.user.infrastructure.stub.UserStub
...
final class ScalaHttpApiTest extends WordSpec with Matchers with ScalaFutures with ScalatestRouteTest {
  ...
  "ScalaHttpApi" should {
    ...
    "respond pong while asking a ping" in {
