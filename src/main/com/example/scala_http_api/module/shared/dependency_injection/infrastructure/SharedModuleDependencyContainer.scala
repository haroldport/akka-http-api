package com.example.scala_http_api.module.shared.dependency_injection.infrastructure

import akka.actor.ActorSystem
import akka.stream.ActorMaterializer
import com.example.scala_http_api.module.shared.bus.domain.MessagePublisher
import com.example.scala_http_api.module.shared.bus.infrastructure.rabbit_mq.{RabbitMqChannelFactory, RabbitMqConfig, RabbitMqMessagePublisher}
import com.example.scala_http_api.module.shared.logger.domain.Logger
import com.example.scala_http_api.module.shared.logger.infrastructure.scala_logging.ScalaLoggingLogger
