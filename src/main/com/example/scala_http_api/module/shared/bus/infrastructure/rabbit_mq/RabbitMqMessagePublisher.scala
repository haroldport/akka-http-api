...
import com.example.scala_http_api.module.shared.bus.domain.{Message, MessagePublisher}
import com.example.scala_http_api.module.shared.marshaller.infrastructure.MessageJsonFormatMarshaller.MessageMarshaller
...
final class RabbitMqMessagePublisher(channelFactory: RabbitMqChannelFactory) extends MessagePublisher {
  ...
  // Example: A message with routing key "scala_api.video_created"
  // will be routed to the "scala_api.video_created" queue.
